...
- TASK-035 — ACCEPTED — Mini App mock exam: start, timed answering, completion
- TASK-036 — ACCEPTED — Mini App exam history and per-question review
...
- TASK-042 — ACCEPTED — Mini App weakest-concept practice scope

Epic 6 is complete. By the accepted Product Owner decision of 2026-09-22, mastery
labelling, spaced repetition and any readiness score are deferred to

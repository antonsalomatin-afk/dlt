...
export function Practice({ session, onExpired, onVehicle, onProgress, onHistory, onMistakes, onFavorites, onExam, onExamHistory }: { session: Session; onExpired: () => void; onVehicle: (missing?: boolean) => void; onProgress: () => void; onHistory: () => void; onMistakes: () => void; onFavorites: () => void; onExam: () => void; onExamHistory: () => void }) {
